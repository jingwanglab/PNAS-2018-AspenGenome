...
tremula_utr_table=data.frame(Distance=tremula_utr_d[order(tremula_utr_d)],r2=tremula_Er(tremula_utr_C_,tremula_utr_d[order(tremula_utr_d)]),species="P.tremula",anno="UTR")
tremuloides_utr_table=data.frame(Distance=tremuloides_utr_d[order(tremuloides_utr_d)],r2=tremuloides_Er(tremuloides_utr_C_,tremuloides_utr_d[order(tremuloides_utr_d)]),species="P.tremuloides",anno="UTR")
trichocarpa_utr_table=data.frame(Distance=trichocarpa_utr_d[order(trichocarpa_utr_d)],r2=trichocarpa_Er(trichocarpa_utr_C_,trichocarpa_utr_d[order(trichocarpa_utr_d)]),species="P.trichocarpa",anno="UTR")
...
tremula_cds_table=data.frame(Distance=tremula_cds_d[order(tremula_cds_d)],r2=tremula_Er(tremula_cds_C_,tremula_cds_d[order(tremula_cds_d)]),species="P.tremula",anno="Coding")
tremuloides_cds_table=data.frame(Distance=tremuloides_cds_d[order(tremuloides_cds_d)],r2=tremuloides_Er(tremuloides_cds_C_,tremuloides_cds_d[order(tremuloides_cds_d)]),species="P.tremuloides",anno="Coding")
trichocarpa_cds_table=data.frame(Distance=trichocarpa_cds_d[order(trichocarpa_cds_d)],r2=trichocarpa_Er(trichocarpa_cds_C_,trichocarpa_cds_d[order(trichocarpa_cds_d)]),species="P.trichocarpa",anno="Coding")
...
tremula_intron_table=data.frame(Distance=tremula_intron_d[order(tremula_intron_d)],r2=tremula_Er(tremula_intron_C_,tremula_intron_d[order(tremula_intron_d)]),species="P.tremula",anno="Intronic")
tremuloides_intron_table=data.frame(Distance=tremuloides_intron_d[order(tremuloides_intron_d)],r2=tremuloides_Er(tremuloides_intron_C_,tremuloides_intron_d[order(tremuloides_intron_d)]),species="P.tremuloides",anno="Intronic")
trichocarpa_intron_table=data.frame(Distance=trichocarpa_intron_d[order(trichocarpa_intron_d)],r2=trichocarpa_Er(trichocarpa_intron_C_,trichocarpa_intron_d[order(trichocarpa_intron_d)]),species="P.trichocarpa",anno="Intronic")
...
tremula_intergenic_table=data.frame(Distance=tremula_intergenic_d[order(tremula_intergenic_d)],r2=tremula_Er(tremula_intergenic_C_,tremula_intergenic_d[order(tremula_intergenic_d)]),species="P.tremula",anno="Intergenic")
tremuloides_intergenic_table=data.frame(Distance=tremuloides_intergenic_d[order(tremuloides_intergenic_d)],r2=tremuloides_Er(tremuloides_intergenic_C_,tremuloides_intergenic_d[order(tremuloides_intergenic_d)]),species="P.tremuloides",anno="Intergenic")
trichocarpa_intergenic_table=data.frame(Distance=trichocarpa_intergenic_d[order(trichocarpa_intergenic_d)],r2=trichocarpa_Er(trichocarpa_intergenic_C_,trichocarpa_intergenic_d[order(trichocarpa_intergenic_d)]),species="P.trichocarpa",anno="Intergenic")
...
tremula_regulatory_table=data.frame(Distance=tremula_regulatory_d[order(tremula_regulatory_d)],r2=tremula_Er(tremula_regulatory_C_,tremula_regulatory_d[order(tremula_regulatory_d)]),species="P.tremula",anno="Regulatory")
tremuloides_regulatory_table=data.frame(Distance=tremuloides_regulatory_d[order(tremuloides_regulatory_d)],r2=tremuloides_Er(tremuloides_regulatory_C_,tremuloides_regulatory_d[order(tremuloides_regulatory_d)]),species="P.tremuloides",anno="Regulatory")
trichocarpa_regulatory_table=data.frame(Distance=trichocarpa_regulatory_d[order(trichocarpa_regulatory_d)],r2=trichocarpa_Er(trichocarpa_regulatory_C_,trichocarpa_regulatory_d[order(trichocarpa_regulatory_d)]),species="P.trichocarpa",anno="Regulatory")
...
tremula_repeats_table=data.frame(Distance=tremula_repeats_d[order(tremula_repeats_d)],r2=tremula_Er(tremula_repeats_C_,tremula_repeats_d[order(tremula_repeats_d)]),species="P.tremula",anno="Repeats")
tremuloides_repeats_table=data.frame(Distance=tremuloides_repeats_d[order(tremuloides_repeats_d)],r2=tremuloides_Er(tremuloides_repeats_C_,tremuloides_repeats_d[order(tremuloides_repeats_d)]),species="P.tremuloides",anno="Repeats")
trichocarpa_repeats_table=data.frame(Distance=trichocarpa_repeats_d[order(trichocarpa_repeats_d)],r2=trichocarpa_Er(trichocarpa_repeats_C_,trichocarpa_repeats_d[order(trichocarpa_repeats_d)]),species="P.trichocarpa",anno="Repeats")


total_table=rbind(tremula_utr_table,tremuloides_utr_table,trichocarpa_utr_table,tremula_cds_table,tremuloides_cds_table,trichocarpa_cds_table,tremula_intron_table,tremuloides_intron_table,trichocarpa_intron_table,tremula_intergenic_table,tremuloides_intergenic_table,trichocarpa_intergenic_table,tremula_regulatory_table,tremuloides_regulatory_table,trichocarpa_regulatory_table,tremula_repeats_table,tremuloides_repeats_table,trichocarpa_repeats_table)

save(total_table,file="total_table.RData")
d=ggplot(total_table,aes(x=Distance,y=r2,colour=species,group=anno))+geom_line(aes(colour = species),size=1.5)
d+facet_wrap(~anno,ncol=1)+scale_color_manual(values=c("#1F78B4","#33A02C","#6A3D9A"),labels=c(expression(italic("P. tremula")),expression(italic("P. tremuloides")),expression(italic("P. trichocarpa"))))+xlab("Distance(bp)")+ylab(expression(r^2))

ggsave("LD.3species.anno.png",width=5,height=7,dpi=600)

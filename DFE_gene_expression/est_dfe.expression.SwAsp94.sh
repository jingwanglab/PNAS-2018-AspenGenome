...
#SBATCH -A b2010014
#SBATCH -p core
#SBATCH -o est_dfe.expression.SwAsp94.out
#SBATCH -e est_dfe.expression.SwAsp94.err
#SBATCH -J est_dfe.expression.SwAsp94.job
#SBATCH -t 2:00:00

####Input ./est_dfe.expression.tremula.sh High high
...
OutDir="/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/$class/$level/$anno/real"

if [ "$step" == "1" ]; then
#####Step1:site_class_0
###submit jobs
##for file in {connectivity,core_gene,eGene,exp_level,exp_variance}; do for file2 in {low,high}; do for file3 in {0_fold,4_fold,intron,utr3,utr5,upstream,downstream}; do sbatch est_dfe.expression.SwAsp94.sh $file $file2 $file3 1; done; done; done
...
##for file in {connectivity,core_gene,eGene,exp_level,exp_variance}; do for file2 in {low,high}; do for file3 in {0_fold,intron,utr3,utr5,upstream,downstream}; do sbatch est_dfe.expression.SwAsp94.sh $file $file2 $file3 3; done; done; done

...
##2.1 connectivity 
low_connectivity_o=filter(eqtls_final,kTotal <= quantile(eqtls_final$kTotal,0.5)) %>% select(gene)
low_connectivity=f(low_connectivity_o)

high_connectivity_o=filter(eqtls_final,kTotal > quantile(eqtls_final$kTotal,0.5)) %>% select(gene)
high_connectivity=f(high_connectivity_o)

##2.2 gene expression level
low_exp_level_o=filter(eqtls_final,orig_expr_mean <= quantile(eqtls_final$orig_expr_mean,0.5)) %>% select(gene)
low_exp_level=f(low_exp_level_o)

high_exp_level_o=filter(eqtls_final,orig_expr_mean > quantile(eqtls_final$orig_expr_mean,0.5)) %>% select(gene)
high_exp_level=f(high_exp_level_o)

##2.3 gene expression variance
low_exp_variance_o=filter(eqtls_final,orig_expr_var <= quantile(eqtls_final$orig_expr_var,0.5)) %>% select(gene)
low_exp_variance=f(low_exp_variance_o)

high_exp_variance_o=filter(eqtls_final,orig_expr_var > quantile(eqtls_final$orig_expr_var,0.5)) %>% select(gene)
high_exp_variance=f(high_exp_variance_o)

##2.4 eGene vs. non-eGene
high_eGene_o=filter(eqtls_final,is_egene == "TRUE") %>% select(gene)
high_eGene=f(high_eGene_o)

low_eGene_o=filter(eqtls_final,is_egene == "FALSE") %>% select(gene)
low_eGene=f(low_eGene_o)

##2.5 core vs. non-core
high_core_gene_o=filter(eqtls_final,is_core_gene == "TRUE") %>% select(gene)
high_core_gene=f(high_core_gene_o)

low_core_gene_o=filter(eqtls_final,is_core_gene == "FALSE") %>% select(gene)
low_core_gene=f(low_core_gene_o)
...
##########write.table
Outfile_low_connectivity=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/connectivity/low/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".connectivity.low.omega.txt",sep="")
...
##########write.table
Outfile_high_connectivity=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/connectivity/high/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".connectivity.high.omega.txt",sep="")
...
##########write.table
Outfile_low_exp_level=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/exp_level/low/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".exp_level.low.omega.txt",sep="")
...
##########write.table
Outfile_high_exp_level=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/exp_level/high/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".exp_level.high.omega.txt",sep="")
...
##########write.table
Outfile_low_exp_variance=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/exp_variance/low/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".exp_variance.low.omega.txt",sep="")
...
##########write.table
Outfile_high_exp_variance=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/exp_variance/high/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".exp_variance.high.omega.txt",sep="")
...
##########write.table
Outfile_low_eGene=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/eGene/low/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".eGene.low.omega.txt",sep="")
...
##########write.table
Outfile_high_eGene=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/eGene/high/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".eGene.high.omega.txt",sep="")
...
##########write.table
Outfile_low_core_gene=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/core_gene/low/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".core_gene.low.omega.txt",sep="")
...
##########write.table
Outfile_high_core_gene=paste("/proj/b2010014/nobackup/population_genetics/DFE_expression/Out/core_gene/high/",anno,"/bootstrap/bootstrap",bootstrap,"/",anno,".core_gene.high.omega.txt",sep="")
